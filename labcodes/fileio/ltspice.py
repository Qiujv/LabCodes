"""Reading data file (.raw) produced by LTSpice.
Adapted from https://github.com/DongHoonPark/ltspice_pytool/blob/master/ltspice/ltspice.py
or https://pypi.org/project/ltspice/.
"""
